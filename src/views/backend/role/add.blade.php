...
<div class="container-fluid">
    <div class="data-header">
        <h4 class="data-title pull-left">添加新角色</h4>
    </div>
    <div class="data">
        <form class="form-horizontal" method="post" action="{{route('rolestore')}}">
            ...
            <div class="form-group">
                ...
                <div class="col-xs-6 col-md-3 col-lg-3">
                    <textarea class="form-control" rows="5" name="role_desc"></textarea>
                </div>
            </div>
            <div class="form-group">
